...
Компʼютер, за параметрами схожий на Raspberry Pi 4 2Gb (~2600 грн.), який окрім всіх необхідних інтерфейсів ПК має доступні через GPIO інтерфейси UART, I2C, SPI, PWM (так пишуть в характеристиках). На процесорах Orange Pi трапляються проблеми з перегрівом, але в гуглі є рекомендації, як вирішити їх незначним пониженням тактової частоти.
