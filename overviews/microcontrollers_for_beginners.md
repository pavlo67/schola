...
Для роботи Raspberry Pi до ціни слід додати ціну SD-картки. Досить простенької картки на 16Gb (краще, звісно, 32), але якщо потрібно зберігати на картці відео, то слід брати картку з високою швидкодією (дешеві — не справляються з відеопотоком).
