...
B.1. [Розробка і помилки. Вимога ясности і місце тестів у розробці](lessons/b1.clarity.md).

B.2. [Цілі і етапи розробки: постановка задачі, функція, пускач, тест-кейси, тести...](lessons/b2.targets.md). 

B.3. [Юніт-тести](lessons/b3.unit_tests.md).

B.4. [Проєктування "згори-донизу", ієрархічна будова коду](lessons/b4.hierarchical_method.md).

B.5. Стиль оформлення коду: форматування (зокрема — стандарти і авто-форматери), лінтери. Програма для читача, програма для 
...
B.11. Процедурна / обʼєктна структура коду. Структурне програмування. Single responsibility. ООП, SOLID. 
...
E.2. Приклад ієрархічного конструювання (простої) програми: решето Ератосфена.

E.3. Web-сервер. Розробка сервера для цих курсів.

E.4. ETL (extract-transform-load). Розробка системи збору новин.
