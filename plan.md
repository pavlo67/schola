...
[Конспекти до занять](https://github.com/pavlo67/schola/tree/master/lessons) — в процесі розробки, звісно ж.
...
систему як слід, проте вони завжди знаходяться, щоб розробити її двічі." Рекомендація: розробка — спершу в голові; чіткість планів.](lessons/b1.clarity.md)

B.2. [Цілі розробки. Рекомендація — чек-ліст по порядку (елементарної) розробки і структурі коду: постановка задачі, функція, пускач, тест-кейси, тести...](lessons/b2.targets.md) 
...
B.3. Ієрархічна побудова, проєктування "зверху-вниз". Структурне програмування (швидкодія vs. ціна підтримки). Single responsibility. 
...
B.8. Контроль. Вхідні параметри програми, вхідні параметри функцій, типи і структури в нетипізованій мові. JS: if (str == "undefined")... Ціна типізації в аспекті швидкодії.

B.9. Параметризація коду - "magic numbers", константи, конфіги. 

B.10. Дублювання коду і помилок vs. суміщення коду і побічні ефекти. Процедурна ієрархія.

B.11. Інтерфейси, поліморфізм, наслідування. Composition over inheritance. "Види інтерфейсів" в Go. Pros and cons.

B.12. Процедурна / обʼєктна структура коду. ООП, SOLID.

B.13. Архітектура системи: Model-View-Controller. Patterns (шаблони, зразки, моделі).

B.14. Модульна/пакетна структура системи: публічні репозиторії і каталоги (NPM), внутрішня структура, Dependency Injection.

B.15. Юніт-тести та інтегральне тестування (ціна помилки: хвилина при компіляції - година при тестуванні - день при відладці). Ручне тестування, API-тестування. Тести — 
підтверджують помилки, але, принципово, не можуть підтвердити їх відсутність. Помилки є скрізь.

B.16. Документація та коментування (зокрема: історія RFC, коментарі в Go, doc-strings в JS/Python). Кращий коментар — добрий код. Але — необхідне коментування мотивів і девіяцій.

B.17. Типічні помилки в розробці і критерії оцінки: швидкість vs. надійність :-); "майже робоча система"; читабельність і красота коду; стабільність системи і легкість 
підтримки-відладки... 

B.18. KISS. YAGNI. If it ain't broke, don't fix it.

B.19. Життєвий цикл розробки і підтримки. Формулювання вимог, дизайни. Agile, scrum, waterfall, kanban... PoC, MVC, alpha-beta releases, release-candidate, release. Оточення: 
...
C.1. [Як освоювати Go (мотиви вибору), приклад коду](lessons/c1.intro.md).
