...
B.1. Розробка — спершу в голові. Чіткість планів. Помилки, помилки, помилки... Ідеал: TDD/BDD, "Test first / docs first." Реальність: "в бізнесу ніколи немає грошей, щоб розробити 
систему як слід, зато вони завжди знаходяться на те, щоб розробити її двічі."
...
B.3. Ієрархічна побудова, проєктування "зверху-вниз". Структурне програмування (швидкодія vs. ціна підтримки). 
...
C.1. Побіжний огляд інструментів, мотиви вибору Go, приклад коду, перші практичні задачі на основі викладеного.
